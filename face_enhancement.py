...
from inswapper.GPEN import __init_paths
from inswapper.GPEN.retinaface.retinaface_detection import RetinaFaceDetection
from inswapper.GPEN.face_model.face_gan import FaceGAN
from inswapper.GPEN.sr_model.real_esrnet import RealESRNet
from inswapper.GPEN.align_faces import warp_and_crop_face, get_reference_facial_points

class FaceEnhancement(object):
    def __init__(self, base_dir='./', size=512, out_size=None, model=None, channel_multiplier=2, narrow=1, key=None, device='cuda', u=True):
